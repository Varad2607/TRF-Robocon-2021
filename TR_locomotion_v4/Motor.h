...
class Motor {
 ...
 //-------------------------------------------------------------------------------------------------------------------------------------------
   ...
   /*
    ...
    Output           :  ~none~
    Logic            :  Will set PWM value of the motor i.e. analogWrite the value stored in the variable to respective pin
 ...
 //-------------------------------------------------------------------------------------------------------------------------------------------
   ...
   /*
    ...
    Input            :  ~none~
    Output           :  ~none~
    Logic            :  Will set Dir value of the motor i.e. digitalWrite the value stored in the variable to respective pin
 ...
 //-------------------------------------------------------------------------------------------------------------------------------------------
   ...
   /*
    ...
    Input            :  ~none~
    Output           :  ~none~
    Logic            :  Will switch Dir value of the motor respective to setDir
