...
//    }
  ...
  //-------------------------------------------------------------------------------------------------------------------------------------------
      /*
        Function Name    :  rotate()  / rotate_empty()
        Input            :  kp
        Output           :  ~none~
        Logic            :  depending upon the potentiometer value, provide pwm to the mechanism
        Example Call     :  rotate(5)  / rotate_empty(5)
      */
    ...
    */
    ...
    /*
      Function Name    :  align_arrows()  / realign_arrows()
      Input            :  ~none~
      Output           :  ~none~
      ...
      Example Call     :  align_arrows()  / realign_arrows()
    */
